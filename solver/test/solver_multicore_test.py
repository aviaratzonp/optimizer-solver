...
try:
	input1.columns=['hour','zone_id','region','country','dma','start_time','end_time','forecast'\
...
input1=input1[(input1.needed_daily_quota!=0) | (input1.skip_daily_goal!=0)]
